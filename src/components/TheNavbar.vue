  ...
  <header class="header" id="header" v-click-outside="() => (mobileNavMenu = false)">
    ...
    <nav class="navbar" :class="{ 'navbar-open': mobileNavMenu }">
      <ul>
        <li v-if="authUser" class="navbar-user">
          ...
          <div id="user-dropdown" :class="{ 'active-drop': userDropdownOpen }">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="dropdown-menu-item"><a @click.prevent="$store.dispatch('auth/signOut'), $router.push({ name: 'Home' })"> Sign Out </a></li>
            </ul>
          </div>
        </li>
        ...
        <li v-if="authUser" class="navbar-mobile-item"><a @click.prevent="$store.dispatch('auth/signOut'), $router.push({ name: 'Home' })"> Sign Out</a></li>
      </ul>
